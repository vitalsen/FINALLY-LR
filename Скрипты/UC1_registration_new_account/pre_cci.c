# 1 "c:\\finally\\scripts\\uc1_registration_new_account\\\\combined_itog1.reg.c"
...
# 1 "c:\\finally\\scripts\\uc1_registration_new_account\\\\combined_itog1.reg.c" 2
...
# 2 "c:\\finally\\scripts\\uc1_registration_new_account\\\\combined_itog1.reg.c" 2
...
opensite(){lr_start_transaction("Open_site");
...
create_new_acc(){lr_start_transaction("click_create_new_account");
...
# 3 "c:\\finally\\scripts\\uc1_registration_new_account\\\\combined_itog1.reg.c" 2
...
# 4 "c:\\finally\\scripts\\uc1_registration_new_account\\\\combined_itog1.reg.c" 2
...
lr_save_string(lr_eval_string("{n1}{n2}{n3}{n4}"), "randomName");
	...
	logout();
	lr_end_transaction("UC01_Register", 2);

	return 0;
}
# 5 "c:\\finally\\scripts\\uc1_registration_new_account\\\\combined_itog1.reg.c" 2
...
# 6 "c:\\finally\\scripts\\uc1_registration_new_account\\\\combined_itog1.reg.c" 2
