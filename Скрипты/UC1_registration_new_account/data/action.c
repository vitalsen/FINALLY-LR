Action()
{
	...
	web_custom_request("AccountCreateRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountCreateRequest xmlns=\"com.advantage.online.store.accountservice\"><accountType>USER</accountType><address>Kadyriva</address><allowOffersPromotion>true</allowOffersPromotion><cityName>Moscow</cityName><countryId>Russia,ru</countryId><email>test@yandex.ru</email>"
		"<firstName>Vitaly</firstName><lastName>Kazarin</lastName><loginName>papa12345</loginName><password>26yjz96ASD</password><phoneNumber>89998204692</phoneNumber><stateProvince>MSC</stateProvince><zipcode></zipcode></AccountCreateRequest></soap:Body></soap:Envelope>", 
		LAST);
	...
	web_custom_request("AccountLoginRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountLoginRequest xmlns=\"com.advantage.online.store.accountservice\"><email>test@yandex.ru</email><loginPassword>26yjz96ASD</loginPassword><loginUser>papa12345</loginUser></AccountLoginRequest></soap:Body></soap:Envelope>", 
		LAST);
	...
	web_url("162217817", 
		"URL=https://www.advantageonlineshopping.com/order/api/v1/carts/162217817", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=https://www.advantageonlineshopping.com/", 
		"Snapshot=t11.inf", 
	...
	web_custom_request("AccountLogoutRequest", 
		...
		"Mode=HTML", 
		"EncType=text/xml; charset=UTF-8", 
		"Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountLogoutRequest xmlns=\"com.advantage.online.store.accountservice\"><loginUser>162217817</loginUser><base64Token>Basic cGFwYTEyMzQ1OjI2eWp6OTZBU0Q=</base64Token></AccountLogoutRequest></soap:Body></soap:Envelope>", 
		LAST);
